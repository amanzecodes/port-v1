const Header = () => {
  return (
    <header
      className={`fixed top-0 left-0 w-full z-30 backdrop-blur-md bg-white/30 shadow-md transition-colors duration-300`}
    >
      <div className="flex items-center justify-between w-full mx-auto px-4 sm:px-6 py-3">
        ...
        <div className="flex flex-row gap-6 items-center">
          <div className="border rounded-full p-2 cursor-pointer hover:bg-stone-900 hover:text-stone-200 transition-all duration-500 border-stone-500 text-black">
            <svg
