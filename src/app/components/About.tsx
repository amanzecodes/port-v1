          ...
          <div className="max-w-[700px]">
            <div className="flex flex-col gap-6">
              <p className="text-xl md:text-2xl lg:text-4xl">
                ...
                websites for businesses and personal brands. With expertise in
                Next.js, TypeScript, and Tailwind CSS, I create fast, visually
                appealing, and user-friendly web experiences that leave a
                lasting impression.
              </p>
              <p className="text-xl md:text-2xl lg:text-4xl">
                Beyond coding, I enjoy gaming, exploring emerging tech trends,
                and listening to Amapiano. I admire Mark Zuckerberg’s impact on
                the tech industry and strive to surpass expectations in my own
                journey.
              </p>
              <p className="text-xl md:text-2xl lg:text-4xl">
